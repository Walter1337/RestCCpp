...
#define RESTC_CPP_LOG_ERROR std::cout  
#define RESTC_CPP_LOG_WARN std::cout    
#define RESTC_CPP_LOG_INFO std::cout   
#define RESTC_CPP_LOG_DEBUG std::cout  
#define RESTC_CPP_LOG_TRACE std::cout  
#endif
